...
def transcribe_recording(
    ...
    Args:
        ...
        provider: Optional STT provider instance name. This is a per-call
            override, so Hermes Voice/Control/Chat can select ``parakeet-lan``
            vs ``parakeet-dockge`` without rewriting global config.
